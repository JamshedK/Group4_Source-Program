...
// public class OptimizerWhatIf extends Execution {
...
//     public OptimizerWhatIf(DataConnectivity data) throws SQLException {
//         super(data);
//         _data = (DB2DATA) data;
...
public class OptimizerWhatIf extends Execution {
    ...
    protected int run() throws Exception {
        ...
        LOG.info("Start execution of Optimizer with WhatIf Estimator with " + _data.getWorkloadName() + " with " + _gamma);
        _output.write("# Optimizer with WhatIf Estimator with " + _data.getWorkloadName() + " with " + _gamma);
        _output.write("# Overhead\tConf_Change\tExec_Time\tWI_Conf_Change\tWI_Exec_Time");
        ...
        for (SQLStatement sqls : wl) {
            ...
            try {
                ...
                real_s0_change_cost = s0.changeToCost(s1);
                real_s1_evaluate = _data.execute(sql);
                real_cost = real_s0_change_cost + real_s1_evaluate;
                ...
                double beta = Math.max(1.0 / index, 1.0 / _data.getNumOfIndexes());
                avgCost_near = (1 - beta) * avgCost_near + beta * hat_theta;
                real_avgCost_near = (1 - beta) * real_avgCost_near + beta * real_cost;
